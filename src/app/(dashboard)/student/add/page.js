...
export default function Page() {
  ...
  const validateAllFields = () => {
    ...
    // Mobile number validation (example pattern for 10 digits)
    ...
    // parent Mobile number validation (example pattern for 10 digits)
    const parentMobileRegex = /^\d{10}$/;
    if (formData.parentMobileNumber && !parentMobileRegex.test(formData.parentMobileNumber)) {
      validationErrors.parentMobileNumber =
        "Please enter a valid 10-digit mobile number";
    }

    // DOB validation (between 5 and 60 years)
    if (formData.dob) {
      const dobDate = new Date(formData.dob);
      const currentDate = new Date();
      const age = currentDate.getFullYear() - dobDate.getFullYear();
      const ageMonthDiff = currentDate.getMonth() - dobDate.getMonth();
      const isAgeValid = age > 5 && age < 60 || (age === 5 && ageMonthDiff >= 0) || (age === 60 && ageMonthDiff <= 0);

      if (!isAgeValid) {
        validationErrors.dob = errorMessages.dob;
      }
    }
      ...
      <div className=" bg-white p-4 max-w-full mx-1 my-2 flex justify-between">
        ...
        <div className="flex">
          <span className="  flex text-gray-400">
            students <AiOutlineRight size={24} />
          </span>
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{
                    borderColor: errors.registrationDate ? "red" : "#ccc",
                  }}
                >
                  <input
                    type="date"
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.rollNo ? "red" : "#ccc" }}
                >
                  <input
                    type="number"
                    placeholder="Roll No"
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.studentClass ? "red" : "#ccc" }}
                >
                  <select
                    name="studentClass"
                    value={formData.studentClass}
                    onChange={handleChange}
                    className={`w-full px-2 py-1 rounded-md h-8`}
                  >
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.gender ? "red" : "#ccc" }}
                >
                  <select
                    name="gender"
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.mobileNumber ? "red" : "#ccc" }}
                >
                  <input
                    type="number"
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.parentName ? "red" : "#ccc" }}
                >
                  <input
                    type="text"
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{
                    borderColor: errors.parentMobileNumber ? "red" : "#ccc",
                  }}
                >
                  <input
                    type="number"
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.dob ? "red" : "#ccc" }}
                >
                  <input
                    type="date"
                    name="dob"
                    value={formData.dob}
                    onChange={handleChange}
                    min={calculateDate(60)}  // Minimum date: 60 years ago
                    max={calculateDate(5)}   // Maximum date: 5 years ago
                    className={` w-full  px-2 py-1  rounded-md`}
                  />
                  {errors.dob && (
                    <AiOutlineInfoCircle className="text-red-500 ml-2" />
              ...
              <div className="w-full md:w-1/2">
                ...
                <div
                  className="flex items-center border rounded-md px-2 py-1"
                  style={{ borderColor: errors.bloodGroup ? "red" : "#ccc" }}
                >
                  <select
                    name="bloodGroup"
            ...
            <div>
              ...
              >
                <textarea
                  ...
                  onChange={handleChange}
                  className={`w-full h-24 px-2 py-1  rounded-md`}
                  placeholder="Address"
                />
                {errors.address && (
                  <AiOutlineInfoCircle className="text-red-500 ml-2" />
